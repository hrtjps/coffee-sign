  ...
  <div class="app">
    <AppHeader fixed>
      ...
      <b-link class="navbar-brand" to="#">
        <img class="navbar-brand-full" src="img/brand/logo.svg" width="89" height="25" alt="CoffeeSign Logo">
        <img class="navbar-brand-minimized" src="img/brand/sygnet.svg" width="30" height="30" alt="CoffeSign Logo">
      </b-link>
    ...
    <TheFooter>
      <!--footer-->
      <div>
        <a href="https://coreui.io">CoffeeSign</a>

    ...
    <div class="w-100">
      ...
      <div class="personal-plan content-card">
        <div>
          ...
          <div class="d-flex align-items-center">
            ...
            <b-button variant="link" class="ml-2">Edit Card</b-button>
          </div>
          <div class="comments">Next Payment: $0.87 on June 1, 2019</div>
        </div>
        <div>
          <div><span class="comments">Available: </span><strong>2/3</strong></div>
          <b-progress :value="30" :max="100" class="mb-3"></b-progress>
          <b-button variant="other" style="width: 186px" v-on:click="editPaymentMethod()">Upgrade Plan</b-button>
        </div>        
      </div>
      ...
      <div class="payment-history">
        ...
        <div class="content-card history-item">
          ...
          <div class="receipt"><b-button variant="link">View PDF</b-button></div>
        </div>
        <div class="content-card history-item">
          <div class="other-fields">May 1, 2019</div>
          <div class="other-fields">Invoice</div>
      ...
      <div class="payment-modal">
        ...
        <form class="w-100 mt-5">
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="first_name" placeholder="Expiration month" name="first_name" required>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <label for="name">Expiration year</label>
                  <input type="text" class="form-control" id="last_name" placeholder="Expiration year" name="last_name" required>
                </div>
              </div>
            </div>
            <div class="row">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="company" placeholder="Enter your billing address" name="company" required>
            </div>
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  <label for="name">Zip code</label>
                  <input type="text" class="form-control" id="company" placeholder="Zip code" name="company" required>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
            ...
            <div class="d-flex justify-content-end align-items-center">
              ...
              <button class="btn btn-link">Revert</button>
